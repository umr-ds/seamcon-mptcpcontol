...
public class PhoneState {
	...
	private static int getDbm(TelephonyManager telephonyManager, SignalStrength signalStrength) {
		if (!signalStrength.isGsm()) {
            return 0;
        }
	...
	private static int getLteLevel(TelephonyManager telephonyManager, SignalStrength signalStrength) {
